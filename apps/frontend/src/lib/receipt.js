...
// Reseñas de Google: escanea y recibe un regalo. (Cambia la URL si tu enlace cambia.)
const REVIEW_URL = 'https://share.google/uZpY0UDHdpYc24fx9';
...
export function buildCustomerReceiptHTML(data, settings = {}) {
  ...
  const inner = `
    ...
    <hr>
    <div class="c b big">⭐ ¡Califícanos en Google!</div>
